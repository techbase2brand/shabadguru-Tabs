...
class UINetease extends LyricUI {
  ...
  @override
  TextStyle getOtherMidTextStyle() => TextStyle(color: Colors.grey[200], fontSize: otherMainSize);
  
  @override
  TextStyle getPlayingMidTextStyle() => TextStyle(
        color: Colors.white,
        fontSize: defaultSize,
      );

        @override
  TextStyle getOtherSpanishTextStyle() => TextStyle(color: Colors.grey[200], fontSize: otherMainSize);
  
  @override
  TextStyle getPlayingSpanishTextStyle() => TextStyle(
        color: Colors.white,
        fontSize: defaultSize,
      );
        @override
  TextStyle getOtherHindiTextStyle() => TextStyle(color: Colors.grey[200], fontSize: otherMainSize);
  
  @override
  TextStyle getPlayingHindiTextStyle() => TextStyle(
        color: Colors.white,
        fontSize: defaultSize,
      );
}
