...
abstract class LyricUI {
  ...
  ///扩展歌词样式（播放行）
  TextStyle getPlayingMidTextStyle();

  ///扩展歌词样式（播放行）
  TextStyle getPlayingSpanishTextStyle();

  ///扩展歌词样式（播放行）
  TextStyle getPlayingHindiTextStyle();
  ...
  ///扩展歌词样式（其他行）
  TextStyle getOtherMidTextStyle();

  ///扩展歌词样式（其他行）
  TextStyle getOtherSpanishTextStyle();

  ///扩展歌词样式（其他行）
  TextStyle getOtherHindiTextStyle();
  ...
  Color getLyricHightlightColor() => Colors.black;

  @override
  String toString() {
    return '${getPlayingMainTextStyle()}'
        '${getPlayingMidTextStyle()}'
        '${getPlayingExtTextStyle()}'
        '${getPlayingSpanishTextStyle()}'
        '${getPlayingHindiTextStyle()}'
        '${getOtherMainTextStyle()}'
        '${getOtherExtTextStyle()}'
        '${getOtherMidTextStyle()}'
        '${getOtherSpanishTextStyle()}'
        '${getOtherHindiTextStyle()}'
        '${getBlankLineHeight()}'
        '${getLineSpace()}'
        '${getInlineSpace()}'
        '${getPlayingLineBias()}'
