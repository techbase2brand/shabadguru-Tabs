...
class LyricsLineModel {
  ...
  bool get hasMid => midText?.isNotEmpty == true;

  bool get hasMain => mainText?.isNotEmpty == true;


  bool get hasSpanish => spanishText?.isNotEmpty == true;

  bool get hasHindi => hindiText?.isNotEmpty == true;
...
class LyricDrawInfo {
  ...
  double get otherMidTextHeight => otherMidTextPainter?.height ?? 0;

  double get otherExtTextHeight => otherExtTextPainter?.height ?? 0;

  double get otherSpanishTextHeight => otherSpanishTextPainter?.height ?? 0;

  double get otherHindiTextHeight => otherHindiTextPainter?.height ?? 0;


  double get playingMainTextHeight => playingMainTextPainter?.height ?? 0;

  double get playingMidTextHeight => playingMidTextPainter?.height ?? 0;

  double get playingExtTextHeight => playingExtTextPainter?.height ?? 0;

  double get playingSpanishTextHeight => playingSpanishTextPainter?.height ?? 0;

  double get playingHindiTextHeight => playingHindiTextPainter?.height ?? 0;


  TextPainter? otherMainTextPainter;
  TextPainter? otherMidTextPainter;
  TextPainter? otherExtTextPainter;
  TextPainter? otherSpanishTextPainter;
  TextPainter? otherHindiTextPainter;

  TextPainter? playingMainTextPainter;
  TextPainter? playingMidTextPainter;
  TextPainter? playingExtTextPainter;
  TextPainter? playingSpanishTextPainter;
  TextPainter? playingHindiTextPainter;
