// Widget for displaying individual Shabad item in home categories list
...
// Widget for displaying a single Shabad item from home categories with play button and menu
class ShabadItem extends StatelessWidget {
  const ShabadItem(
      {super.key,
