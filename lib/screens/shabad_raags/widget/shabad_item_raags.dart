// Widget for displaying individual Shabad item in Raags list
...
// Widget for displaying a single Shabad item from Raags with play button and menu
class ShabadItemRaags extends StatelessWidget {
  const ShabadItemRaags(
      {super.key,
