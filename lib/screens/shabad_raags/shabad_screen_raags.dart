// Screen for displaying Shabads from Raags (musical modes)
import 'package:flutter/material.dart';
import 'package:flutter_staggered_animations/flutter_staggered_animations.dart';
import 'package:get/get_state_manager/get_state_manager.dart';
import 'package:provider/provider.dart';
import 'package:shabadguru/screens/shabad_raags/shabad_controller_raags.dart';
import 'package:shabadguru/screens/shabad_raags/widget/shabad_item_raags.dart';
import 'package:shabadguru/utils/colors.dart';
import 'package:shabadguru/utils/dark_mode/app_state_notifier.dart';
import 'package:shabadguru/utils/global.dart';
import 'package:shabadguru/utils/routes.dart';

// Screen for displaying list of Shabads from Raags with animations
class ShabadScreenRaags extends StatelessWidget {
  const ShabadScreenRaags(
      {super.key,
      required this.categoryId,
      required this.id,
      required this.title});

  final String categoryId; // Category identifier for the Raag
  final String id; // Unique identifier for the Raag
  final String title; // Title of the Raag

  // Build the Shabad Raags screen UI
  @override
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ShabadControllerRaags>(
      init: ShabadControllerRaags(categoryId: categoryId, id: id, title: title), // Initialize controller
      builder: (controller) {
        return Scaffold(
