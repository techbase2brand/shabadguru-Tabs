// Controller for managing Shabad data from Raags (musical modes)
...
// Controller for managing Shabad operations from Raags including data loading and menu options
class ShabadControllerRaags extends GetxController {
  ShabadControllerRaags(
  ...
  String categoryId = ''; // Category identifier for the Raag
  String id = ''; // Unique identifier for the Raag
            ...
            children: [
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  shabadData.title = title; // Set Raag title
...
//     bool isFindShabad =
//         myFavoriteListShabad.any((item) => item.audio == shabadData.audio);

//     showModalBottomSheet(
//       context: context,
//       isScrollControlled:
//           true, // Adjust if you want the height to be scrollable
//       useRootNavigator: true,
//       builder: (context) {
//         return Container(
//           height: audioHandler != null ? 320 : 260,
